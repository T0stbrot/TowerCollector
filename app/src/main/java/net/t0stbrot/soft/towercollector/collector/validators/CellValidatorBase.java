package net.t0stbrot.soft.towercollector.collector.validators;

import net.t0stbrot.soft.towercollector.collector.validators.specific.CdmaCellValidator;
import net.t0stbrot.soft.towercollector.collector.validators.specific.GsmCellValidator;
import net.t0stbrot.soft.towercollector.collector.validators.specific.LteCellValidator;
import net.t0stbrot.soft.towercollector.collector.validators.specific.NrCellValidator;
import net.t0stbrot.soft.towercollector.collector.validators.specific.TdscdmaCellValidator;
