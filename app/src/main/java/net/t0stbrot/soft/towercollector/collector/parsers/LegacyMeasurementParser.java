...
import net.t0stbrot.soft.towercollector.events.LegacyMeasurementProcessingEvent;
import net.t0stbrot.soft.towercollector.events.MeasurementSavedEvent;
import net.t0stbrot.soft.towercollector.events.MeasurementsCollectedEvent;
